-- =============================================================================
-- 01_reference_tables.sql  —  Apex Athletics Content Supply Chain
-- Creates: PRODUCT_CATEGORIES, LOYALTY_TIERS, MARKETING_CAMPAIGNS,
--          STORES, PROMOTIONS, AUDIENCE_SEGMENTS
-- All populated with SQL VALUES (no external files required).
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- PRODUCT_CATEGORIES — 12 activewear-specific categories
-- ---------------------------------------------------------------------------
